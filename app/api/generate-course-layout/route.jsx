...
const PROMPT = `Genrate Learning Course depends on following details. In which Make sure to add Course Name, Description,Course Banner Image Prompt for Course Banner in 3d format Chapter Name, Topic under each chapters, Duration for each chapters etc, in JSON format only
...
Schema:
{
  "course": {
    ...
    "chapters": [{"chapterName": "string", "duration": "string", "topics": ["string"]}]
  }
}
...
export async function POST(request) {
  try {
    ...
    const courseImage = await generateCourseImage(formData.name || formData.topic || 'education', formData.category || 'learning');
