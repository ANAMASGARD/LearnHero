  ...
  return (
    <div className="p-8 bg-white rounded-xl shadow-md max-w-2xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Share this link with candidates to start the interview</p>
      </div>

      <div className="bg-gray-50 p-4 rounded-lg mb-6">
        <label className="text-sm font-medium text-gray-700 mb-2 block">Interview Link</label>
      ...
      <div className="space-y-3 mb-6">
        <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
          ...
          <span className="text-sm text-gray-700">{formData.jobPosition}</span>
        </div>
        <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
          <span className="text-sm font-medium">Duration:</span>
          <span className="text-sm text-gray-700">{formData.duration}</span>
        </div>
        <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
          <span className="text-sm font-medium">Interview ID:</span>
          <span className="text-sm text-gray-700 font-mono">{interview_id}</span>
        </div>
      </div>
